(function($, _) { // wrap in anonymous function to not show some helper variables
   ...
   var translations = {
     ...
     en: {
       ...
       order: function() {
         return "Statements in your program are wrong, or in the wrong order. This can be fixed by moving, removing, or replacing highlighted fragments.";},
       lines_missing: function() {
         return "You need to include all of the statements.";},
       lines_too_many: function() {
         return "Your answer has too many statements.";},
       no_matching: function(lineNro) {
